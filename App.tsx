...
const App: React.FC = () => {
  ...
  const handleGenerateCode = async () => {
    ...
    // Note: We removed the forced popup logic. If keys are missing for premium providers, 
    // imageService will just fail gracefully or users should check settings themselves.
    // LoremFlickr (default) needs no key.
